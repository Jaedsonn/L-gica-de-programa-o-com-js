...
window.addEventListener("load", () => {
    ...
    criarMoedas(num1_00, "1_00.jpg", alt1_00, "moedas1-00")
    criarMoedas(num0_50, "0_50.jpg", alt0_50, "moedas0-50")
    criarMoedas(num0_25, "0_25.jpg", alt0_25, "moedas0-25")
    criarMoedas(num0_10, "0_10.jpg", alt0_10, "moedas0-10")
})
...
frm.addEventListener("submit", (e) => {
    ...
    for (const moeda of moedas) {
        if (moeda.className == "moedas1-00") {
            totalMoedas += 1
        } else if (moeda.className == "moedas0-50") {
            totalMoedas += 0.50
